...
{
	///<summary>
	/// Flow Test Result Share
	///<para>SObject Name: FlowTestResultShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfFlowTestResultShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "FlowTestResultShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: FlowTestResult
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfFlowTestResult Parent { get; set; }
