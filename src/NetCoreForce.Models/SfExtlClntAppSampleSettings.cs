...
namespace NetCoreForce.Models
{
	...
	///</summary>
	public class SfExtlClntAppSampleSettings : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppSampleSettings"; }
		}
		...
		///<summary>
		/// Policy1
		/// <para>Name: DevManagedPolicyFieldsPolicy1</para>
		/// <para>SF Type: boolean</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "devManagedPolicyFieldsPolicy1")]
		[Updateable(false), Createable(false)]
		public bool? DevManagedPolicyFieldsPolicy1 { get; set; }

		///<summary>
		/// Policy2
		/// <para>Name: DevManagedPolicyFieldsPolicy2</para>
		/// <para>SF Type: boolean</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "devManagedPolicyFieldsPolicy2")]
		[Updateable(false), Createable(false)]
		public bool? DevManagedPolicyFieldsPolicy2 { get; set; }
