...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: ApiAnomalyEventStoreFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfApiAnomalyEventStoreFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ApiAnomalyEventStoreFeed"; }
		}
		...
		///<summary>
		/// ReferenceTo: ApiAnomalyEventStore
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfApiAnomalyEventStore Parent { get; set; }
