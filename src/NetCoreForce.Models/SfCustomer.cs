...
namespace NetCoreForce.Models
{
	///<summary>
	/// Customer
	///<para>SObject Name: Customer</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfCustomer : SObject
	{
		[JsonIgnore]
		...
		/// <para>Name: TotalLifeTimeValue</para>
		/// <para>SF Type: int</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "totalLifeTimeValue")]
		public int? TotalLifeTimeValue { get; set; }

		///<summary>
		/// Customer Status Type
		/// <para>Name: CustomerStatusType</para>
		/// <para>SF Type: picklist</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "customerStatusType")]
