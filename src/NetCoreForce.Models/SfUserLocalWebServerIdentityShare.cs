...
{
	///<summary>
	/// User Local Web Server Identity Share
	///<para>SObject Name: UserLocalWebServerIdentityShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfUserLocalWebServerIdentityShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "UserLocalWebServerIdentityShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: UserLocalWebServerIdentity
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfUserLocalWebServerIdentity Parent { get; set; }
