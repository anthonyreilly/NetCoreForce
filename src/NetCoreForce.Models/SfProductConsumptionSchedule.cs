...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: ProductConsumptionSchedule</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfProductConsumptionSchedule : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ProductConsumptionSchedule"; }
		}

		///<summary>
		/// Product Consumption Schedule ID
		/// <para>Name: Id</para>
		...
		/// <para>RelationshipName: Product</para>
		///</summary>
		[JsonProperty(PropertyName = "product")]
		[Updateable(false), Createable(false)]
		public SfProduct2 Product { get; set; }
