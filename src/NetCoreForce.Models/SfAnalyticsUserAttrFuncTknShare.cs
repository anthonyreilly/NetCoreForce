...
{
	///<summary>
	/// Analytics User Attribute Function Token Share
	///<para>SObject Name: AnalyticsUserAttrFuncTknShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfAnalyticsUserAttrFuncTknShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "AnalyticsUserAttrFuncTknShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: AnalyticsUserAttrFuncTkn
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfAnalyticsUserAttrFuncTkn Parent { get; set; }
