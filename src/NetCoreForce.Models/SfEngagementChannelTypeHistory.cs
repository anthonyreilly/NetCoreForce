...
{
	///<summary>
	/// Engagement Channel Type  History
	///<para>SObject Name: EngagementChannelTypeHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfEngagementChannelTypeHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "EngagementChannelTypeHistory"; }
		}

		///<summary>
		/// Engagement Channel Type  History ID
		/// <para>Name: Id</para>
