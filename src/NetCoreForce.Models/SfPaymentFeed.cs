...
{
	///<summary>
	/// __MISSING LABEL__ PropertyFile - val Payment not found in section StandardFeedLabel
	///<para>SObject Name: PaymentFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfPaymentFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "PaymentFeed"; }
		}
		...
		[Updateable(false), Createable(false)]
		public SfPayment Parent { get; set; }
