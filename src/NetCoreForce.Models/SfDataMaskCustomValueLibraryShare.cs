...
{
	///<summary>
	/// Custom Library Share
	///<para>SObject Name: DataMaskCustomValueLibraryShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfDataMaskCustomValueLibraryShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "DataMaskCustomValueLibraryShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: DataMaskCustomValueLibrary
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfDataMaskCustomValueLibrary Parent { get; set; }
