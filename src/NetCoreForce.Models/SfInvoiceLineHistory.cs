...
namespace NetCoreForce.Models
{
	...
	///</summary>
	public class SfInvoiceLineHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "InvoiceLineHistory"; }
		}
		...
		///<summary>
		/// Invoice Line ID
		/// <para>Name: InvoiceLineId</para>
		/// <para>SF Type: reference</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "invoiceLineId")]
		[Updateable(false), Createable(false)]
		public string InvoiceLineId { get; set; }

		///<summary>
		/// ReferenceTo: InvoiceLine
		/// <para>RelationshipName: InvoiceLine</para>
		///</summary>
		[JsonProperty(PropertyName = "invoiceLine")]
		[Updateable(false), Createable(false)]
		public SfInvoiceLine InvoiceLine { get; set; }
