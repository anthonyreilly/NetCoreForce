...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: UserDefinedLabelAssignmentShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfUserDefinedLabelAssignmentShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "UserDefinedLabelAssignmentShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: UserDefinedLabelAssignment
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfUserDefinedLabelAssignment Parent { get; set; }
