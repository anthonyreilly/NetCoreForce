...
{
	///<summary>
	/// External Client Application Mobile Settings
	///<para>SObject Name: ExtlClntAppMobileSettings</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppMobileSettings : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppMobileSettings"; }
		}
		...
		///<summary>
		/// Screen Lock Enabled
		/// <para>Name: IsScreenLockEnabled</para>
		/// <para>SF Type: boolean</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "isScreenLockEnabled")]
		[Updateable(false), Createable(false)]
