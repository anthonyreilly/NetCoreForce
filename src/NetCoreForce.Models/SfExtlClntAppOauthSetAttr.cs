...
{
	///<summary>
	/// External Client App OAuth Settings Custom Attribute
	///<para>SObject Name: ExtlClntAppOauthSetAttr</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppOauthSetAttr : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppOauthSetAttr"; }
		}

		///<summary>
		/// External Client App OAuth Settings Custom Attribute ID
		/// <para>Name: Id</para>
