...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: AlternativePaymentMethodShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfAlternativePaymentMethodShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "AlternativePaymentMethodShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: AlternativePaymentMethod
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfAlternativePaymentMethod Parent { get; set; }
