...
{
	///<summary>
	/// Tableau Host Mapping Share
	///<para>SObject Name: TableauHostMappingShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfTableauHostMappingShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "TableauHostMappingShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: TableauHostMapping
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfTableauHostMapping Parent { get; set; }
