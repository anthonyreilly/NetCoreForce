...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: AlternativePaymentMethod</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfAlternativePaymentMethod : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "AlternativePaymentMethod"; }
		}

		///<summary>
		/// Alternative Payment Method ID
		/// <para>Name: Id</para>
		...
		///<summary>
		/// Alternative Payment Method Number
		/// <para>Name: AlternativePaymentMethodNumber</para>
		/// <para>SF Type: string</para>
		/// <para>AutoNumber field</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "alternativePaymentMethodNumber")]
		[Updateable(false), Createable(false)]
		public string AlternativePaymentMethodNumber { get; set; }
