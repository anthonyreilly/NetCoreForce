...
{
	///<summary>
	/// User Prioritized Record Share
	///<para>SObject Name: UserPrioritizedRecordShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfUserPrioritizedRecordShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "UserPrioritizedRecordShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: UserPrioritizedRecord
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfUserPrioritizedRecord Parent { get; set; }
