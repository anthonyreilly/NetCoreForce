...
namespace NetCoreForce.Models
{
	///<summary>
	/// Goal Share
	///<para>SObject Name: TodayGoalShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfTodayGoalShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "TodayGoalShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: TodayGoal
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfTodayGoal Parent { get; set; }
