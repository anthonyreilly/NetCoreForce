...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: PermissionSetGroupComponent</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfPermissionSetGroupComponent : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "PermissionSetGroupComponent"; }
		}

		///<summary>
		/// PermissionSetGroupComponent ID
		/// <para>Name: Id</para>
		...
		///<summary>
		/// PermissionSet ID or MutingPermissionSet ID
