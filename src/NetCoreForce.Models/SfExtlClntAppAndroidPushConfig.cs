...
{
	///<summary>
	/// External Client Application Android Push Configuration
	///<para>SObject Name: ExtlClntAppAndroidPushConfig</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppAndroidPushConfig : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppAndroidPushConfig"; }
		}

		///<summary>
		/// External Client Application Android Push Configuration ID
		/// <para>Name: Id</para>
		...
		///<summary>
		/// Project Id
		/// <para>Name: FcmProject</para>
		/// <para>SF Type: string</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "fcmProject")]
		[Updateable(false), Createable(false)]
		public string FcmProject { get; set; }

		///<summary>
		/// Service Key
		/// <para>Name: ServiceAccount</para>
		...
		///<summary>
		/// Current Android Push Configuration
