...
{
	///<summary>
	/// Consumption Schedule History ID
	///<para>SObject Name: ConsumptionScheduleHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfConsumptionScheduleHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ConsumptionScheduleHistory"; }
		}
