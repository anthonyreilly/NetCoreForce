...
{
	///<summary>
	/// Data Use Purpose History
	///<para>SObject Name: DataUsePurposeHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfDataUsePurposeHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "DataUsePurposeHistory"; }
		}

		///<summary>
		/// Data Use Purpose History ID
		/// <para>Name: Id</para>
