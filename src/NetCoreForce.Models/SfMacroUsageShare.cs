...
namespace NetCoreForce.Models
{
	///<summary>
	/// Macro Usage Share
	///<para>SObject Name: MacroUsageShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfMacroUsageShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "MacroUsageShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: MacroUsage
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfMacroUsage Parent { get; set; }
