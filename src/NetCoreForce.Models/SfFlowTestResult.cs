...
namespace NetCoreForce.Models
{
	///<summary>
	/// Flow Test Result
	///<para>SObject Name: FlowTestResult</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfFlowTestResult : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "FlowTestResult"; }
		}
		...
		///<summary>
		/// Flow Test View ID
		/// <para>Name: FlowTestViewId</para>
		/// <para>SF Type: string</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "flowTestViewId")]
		[Updateable(false), Createable(false)]
		public string FlowTestViewId { get; set; }
		...
		/// <para>Name: TestStartDateTime</para>
		/// <para>SF Type: datetime</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "testStartDateTime")]
		[Updateable(false), Createable(false)]
		public DateTimeOffset? TestStartDateTime { get; set; }

		///<summary>
		/// Test End Date and Time
		/// <para>Name: TestEndDateTime</para>
		/// <para>SF Type: datetime</para>
		/// <para>Nillable: True</para>
		///</summary>
