...
{
	///<summary>
	/// Guest User Anomaly Event Store Feed
	///<para>SObject Name: GuestUserAnomalyEventStoreFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfGuestUserAnomalyEventStoreFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "GuestUserAnomalyEventStoreFeed"; }
		}
		...
		///<summary>
		/// ReferenceTo: GuestUserAnomalyEventStore
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfGuestUserAnomalyEventStore Parent { get; set; }
