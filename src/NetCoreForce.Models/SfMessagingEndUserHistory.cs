...
{
	///<summary>
	/// Messaging User History
	///<para>SObject Name: MessagingEndUserHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfMessagingEndUserHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "MessagingEndUserHistory"; }
		}

		///<summary>
		/// Messaging User History ID
		/// <para>Name: Id</para>
