...
namespace NetCoreForce.Models
{
	///<summary>
	/// Prompt Error Share
	///<para>SObject Name: PromptErrorShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfPromptErrorShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "PromptErrorShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: PromptError
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfPromptError Parent { get; set; }
