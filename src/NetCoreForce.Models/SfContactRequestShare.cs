...
{
	///<summary>
	/// Contact Request Share
	///<para>SObject Name: ContactRequestShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfContactRequestShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ContactRequestShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: ContactRequest
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfContactRequest Parent { get; set; }
