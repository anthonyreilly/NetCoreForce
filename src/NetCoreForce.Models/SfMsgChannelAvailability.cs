...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: MsgChannelAvailability</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfMsgChannelAvailability : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "MsgChannelAvailability"; }
		}

		///<summary>
		/// Messaging Channel Availability ID
		/// <para>Name: Id</para>
