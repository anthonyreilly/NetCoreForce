...
namespace NetCoreForce.Models
{
	///<summary>
	/// Seller History
	///<para>SObject Name: SellerHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfSellerHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "SellerHistory"; }
		}
		...
		///<summary>
		/// ReferenceTo: Seller
		/// <para>RelationshipName: Seller</para>
		///</summary>
		[JsonProperty(PropertyName = "seller")]
		[Updateable(false), Createable(false)]
		public SfSeller Seller { get; set; }
