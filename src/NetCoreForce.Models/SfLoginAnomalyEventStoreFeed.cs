...
{
	///<summary>
	/// Login Anomaly Event Store Feed
	///<para>SObject Name: LoginAnomalyEventStoreFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfLoginAnomalyEventStoreFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "LoginAnomalyEventStoreFeed"; }
		}
		...
		///<summary>
		/// ReferenceTo: LoginAnomalyEventStore
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfLoginAnomalyEventStore Parent { get; set; }
