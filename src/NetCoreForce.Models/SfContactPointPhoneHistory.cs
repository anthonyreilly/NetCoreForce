...
{
	///<summary>
	/// Contact Point Phone History
	///<para>SObject Name: ContactPointPhoneHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfContactPointPhoneHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ContactPointPhoneHistory"; }
		}

		///<summary>
		/// Contact Point Phone History ID
		/// <para>Name: Id</para>
