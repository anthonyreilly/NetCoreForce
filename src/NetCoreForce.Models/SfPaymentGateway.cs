...
namespace NetCoreForce.Models
{
	///<summary>
	/// Payment Gateway
	///<para>SObject Name: PaymentGateway</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfPaymentGateway : SObject
	{
		[JsonIgnore]
		...
		/// <para>Name: PaymentGatewayName</para>
		...
		/// <para>RelationshipName: MerchantCredential</para>
		///</summary>
		[JsonProperty(PropertyName = "merchantCredential")]
		[Updateable(false), Createable(false)]
		public SfNamedCredential MerchantCredential { get; set; }
