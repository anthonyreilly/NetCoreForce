...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: CredentialStuffingEventStoreFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfCredentialStuffingEventStoreFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "CredentialStuffingEventStoreFeed"; }
		}
		...
		///<summary>
		/// ReferenceTo: CredentialStuffingEventStore
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfCredentialStuffingEventStore Parent { get; set; }
