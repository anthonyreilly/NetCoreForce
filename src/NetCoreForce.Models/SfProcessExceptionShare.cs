...
{
	///<summary>
	/// Process Exception Share
	///<para>SObject Name: ProcessExceptionShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfProcessExceptionShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ProcessExceptionShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: ProcessException
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfProcessException Parent { get; set; }
