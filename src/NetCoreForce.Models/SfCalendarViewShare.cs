...
namespace NetCoreForce.Models
{
	///<summary>
	/// Calendar Share
	///<para>SObject Name: CalendarViewShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfCalendarViewShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "CalendarViewShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: CalendarView
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfCalendarView Parent { get; set; }
