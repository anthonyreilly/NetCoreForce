...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: CommSubscriptionHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfCommSubscriptionHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "CommSubscriptionHistory"; }
		}

		///<summary>
		/// Communication Subscription  History ID
		/// <para>Name: Id</para>
