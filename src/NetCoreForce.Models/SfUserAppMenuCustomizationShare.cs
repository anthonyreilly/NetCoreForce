...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: UserAppMenuCustomizationShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfUserAppMenuCustomizationShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "UserAppMenuCustomizationShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: UserAppMenuCustomization
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Creatable(false)]
		public SfUserAppMenuCustomization Parent { get; set; }
