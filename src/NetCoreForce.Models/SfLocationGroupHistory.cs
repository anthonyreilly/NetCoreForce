...
{
	///<summary>
	/// Location Group History
	///<para>SObject Name: LocationGroupHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfLocationGroupHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "LocationGroupHistory"; }
		}

		///<summary>
		/// Location Group History ID
		/// <para>Name: Id</para>
