...
{
	///<summary>
	/// List Email Individual Recipient
	///<para>SObject Name: ListEmailIndividualRecipient</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfListEmailIndividualRecipient : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ListEmailIndividualRecipient"; }
		}

		///<summary>
		/// List Email Individual Recipient ID
		/// <para>Name: Id</para>
