...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: StreamingChannelShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfStreamingChannelShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "StreamingChannelShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: StreamingChannel
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfStreamingChannel Parent { get; set; }
