...
namespace NetCoreForce.Models
{
	...
	///</summary>
	public class SfExpressionFilter : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExpressionFilter"; }
		}
		...
		///</summary>
		[JsonProperty(PropertyName = "filterConditionLogic")]
		public string FilterConditionLogic { get; set; }

		///<summary>
		/// Macro Instruction ID
		/// <para>Name: ContextId</para>
		/// <para>SF Type: reference</para>
		/// <para>Nillable: False</para>
		///</summary>
		...
		///<summary>
		/// ReferenceTo: MacroInstruction
		/// <para>RelationshipName: Context</para>
		///</summary>
