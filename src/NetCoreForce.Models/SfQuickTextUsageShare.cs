...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: QuickTextUsageShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfQuickTextUsageShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "QuickTextUsageShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: QuickTextUsage
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfQuickTextUsage Parent { get; set; }
