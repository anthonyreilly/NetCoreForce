...
{
	///<summary>
	/// User Email Preferred Person Share
	///<para>SObject Name: UserEmailPreferredPersonShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfUserEmailPreferredPersonShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "UserEmailPreferredPersonShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: UserEmailPreferredPerson
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfUserEmailPreferredPerson Parent { get; set; }
