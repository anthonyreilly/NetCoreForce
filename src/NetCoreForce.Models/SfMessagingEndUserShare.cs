...
{
	///<summary>
	/// Messaging User Share
	///<para>SObject Name: MessagingEndUserShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfMessagingEndUserShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "MessagingEndUserShare"; }
		}
		...
		[Updateable(false), Createable(false)]
		public SfMessagingEndUser Parent { get; set; }
