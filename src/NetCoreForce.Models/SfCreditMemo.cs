...
namespace NetCoreForce.Models
{
	///<summary>
	/// Credit Memo
	///<para>SObject Name: CreditMemo</para>
	...
	public class SfCreditMemo : SObject
	{
		...
		///<summary>
		/// Credit Memo Number
		/// <para>Name: CreditMemoNumber</para>
		/// <para>SF Type: string</para>
		/// <para>Nillable: True</para>
		///</summary>
		...
		/// <para>Name: TotalCreditAmountApplied</para>
		/// <para>SF Type: currency</para>
		/// <para>Nillable: True</para>
		///</summary>
		...
		/// <para>Name: TotalCreditAmountUnapplied</para>
		/// <para>SF Type: currency</para>
		/// <para>Nillable: True</para>
		///</summary>
