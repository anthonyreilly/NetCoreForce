...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: CommSubscriptionConsentHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfCommSubscriptionConsentHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "CommSubscriptionConsentHistory"; }
		}

		///<summary>
		/// Communication Subscription Consent  History ID
		/// <para>Name: Id</para>
