...
{
	///<summary>
	/// External Event Mapping Share
	///<para>SObject Name: ExternalEventMappingShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExternalEventMappingShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExternalEventMappingShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: ExternalEventMapping
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfExternalEventMapping Parent { get; set; }
