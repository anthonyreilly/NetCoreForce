...
{
	///<summary>
	/// OAuth Custom Scope App 
	///<para>SObject Name: OauthCustomScopeApp</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfOauthCustomScopeApp : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "OauthCustomScopeApp"; }
		}

		///<summary>
		/// Oauth Custom Scope App ID
		/// <para>Name: Id</para>
