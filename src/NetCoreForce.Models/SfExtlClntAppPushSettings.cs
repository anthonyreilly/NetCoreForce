...
{
	///<summary>
	/// External Client Application Push Settings
	///<para>SObject Name: ExtlClntAppPushSettings</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppPushSettings : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppPushSettings"; }
		}
		...
		///<summary>
		/// Push Service Type
		/// <para>Name: PushServiceType</para>
		/// <para>SF Type: picklist</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "pushServiceType")]
		[Updateable(false), Createable(false)]
		public string PushServiceType { get; set; }

		///<summary>
		/// Push Config Link
		/// <para>Name: PushConfigLink</para>
		/// <para>SF Type: string</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "pushConfigLink")]
		[Updateable(false), Createable(false)]
		public string PushConfigLink { get; set; }
