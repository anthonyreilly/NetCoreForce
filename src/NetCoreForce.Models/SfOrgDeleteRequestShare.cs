...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: OrgDeleteRequestShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfOrgDeleteRequestShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "OrgDeleteRequestShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: OrgDeleteRequest
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfOrgDeleteRequest Parent { get; set; }
