...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: SessionHijackingEventStoreFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfSessionHijackingEventStoreFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "SessionHijackingEventStoreFeed"; }
		}
		...
		///<summary>
		/// ReferenceTo: SessionHijackingEventStore
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfSessionHijackingEventStore Parent { get; set; }
