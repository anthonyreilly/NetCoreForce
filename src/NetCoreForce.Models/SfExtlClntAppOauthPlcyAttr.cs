...
{
	///<summary>
	/// External Client App OAuth Policies Custom Attribute
	///<para>SObject Name: ExtlClntAppOauthPlcyAttr</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppOauthPlcyAttr : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppOauthPlcyAttr"; }
		}

		///<summary>
		/// External Client App OAuth Policies Custom Attribute ID
		/// <para>Name: Id</para>
