...
{
	///<summary>
	/// Guest User Anomaly Event Store
	///<para>SObject Name: GuestUserAnomalyEventStore</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfGuestUserAnomalyEventStore : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "GuestUserAnomalyEventStore"; }
		}

		///<summary>
		/// Guest User Anomaly Event Store ID
		/// <para>Name: Id</para>
		...
		///<summary>
		/// Event Name
		/// <para>Name: GuestUserAnomalyEventNumber</para>
		/// <para>SF Type: string</para>
		/// <para>AutoNumber field</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "guestUserAnomalyEventNumber")]
		[Updateable(false), Createable(false)]
		public string GuestUserAnomalyEventNumber { get; set; }
		...
		///<summary>
		/// Requested Entities
		/// <para>Name: RequestedEntities</para>
		/// <para>SF Type: textarea</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "requestedEntities")]
		[Updateable(false), Createable(false)]
		public string RequestedEntities { get; set; }

		///<summary>
		/// Total Controller Events
		/// <para>Name: TotalControllerEvents</para>
		/// <para>SF Type: int</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "totalControllerEvents")]
		[Updateable(false), Createable(false)]
		public int? TotalControllerEvents { get; set; }
		...
		///<summary>
		/// SOQL Commands
		/// <para>Name: SoqlCommands</para>
		/// <para>SF Type: textarea</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "soqlCommands")]
		[Updateable(false), Createable(false)]
		public string SoqlCommands { get; set; }
