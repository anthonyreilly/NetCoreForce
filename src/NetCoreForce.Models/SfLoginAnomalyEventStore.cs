...
{
	///<summary>
	/// Login Anomaly Event Store
	///<para>SObject Name: LoginAnomalyEventStore</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfLoginAnomalyEventStore : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "LoginAnomalyEventStore"; }
		}

		///<summary>
		/// Login Anomaly Event Store ID
		/// <para>Name: Id</para>
		...
		///<summary>
		/// Event Name
		/// <para>Name: LoginAnomalyEventNumber</para>
		/// <para>SF Type: string</para>
		/// <para>AutoNumber field</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "loginAnomalyEventNumber")]
		[Updateable(false), Createable(false)]
		public string LoginAnomalyEventNumber { get; set; }
		...
		///<summary>
		/// FeatureContribution
		/// <para>Name: FeatureContribution</para>
		/// <para>SF Type: double</para>
		/// <para>Nillable: True</para>
		///</summary>
		[JsonProperty(PropertyName = "featureContribution")]
		[Updateable(false), Createable(false)]
		public double? FeatureContribution { get; set; }
