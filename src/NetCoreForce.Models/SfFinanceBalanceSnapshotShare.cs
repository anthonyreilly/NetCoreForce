...
{
	///<summary>
	/// Finance Balance Snapshot Share
	///<para>SObject Name: FinanceBalanceSnapshotShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfFinanceBalanceSnapshotShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "FinanceBalanceSnapshotShare"; }
		}
		...
		///<summary>
		/// ReferenceTo: FinanceBalanceSnapshot
		/// <para>RelationshipName: Parent</para>
		///</summary>
		[JsonProperty(PropertyName = "parent")]
		[Updateable(false), Createable(false)]
		public SfFinanceBalanceSnapshot Parent { get; set; }
