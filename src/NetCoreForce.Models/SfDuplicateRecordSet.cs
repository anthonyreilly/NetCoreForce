...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: DuplicateRecordSet</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfDuplicateRecordSet : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "DuplicateRecordSet"; }
		}
		...
		///<summary>
		/// ReferenceTo: DuplicateRule
		/// <para>RelationshipName: DuplicateRule</para>
		///</summary>
		[JsonProperty(PropertyName = "duplicateRule")]
		[Updateable(false), Createable(false)]
		public SfDuplicateRule DuplicateRule { get; set; }
