...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: AuthConfigProviders</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfAuthConfigProviders : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "AuthConfigProviders"; }
		}
		...
		///<summary>
		/// ReferenceTo: AuthConfig
		/// <para>RelationshipName: AuthConfig</para>
		///</summary>
		[JsonProperty(PropertyName = "authConfig")]
		[Updateable(false), Createable(false)]
		public SfAuthConfig AuthConfig { get; set; }
