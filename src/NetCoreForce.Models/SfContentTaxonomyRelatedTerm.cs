...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: ContentTaxonomyRelatedTerm</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfContentTaxonomyRelatedTerm : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ContentTaxonomyRelatedTerm"; }
		}

		///<summary>
		/// Content Taxonomy Related Term ID
		/// <para>Name: Id</para>
