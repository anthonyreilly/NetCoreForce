...
namespace NetCoreForce.Models
{
	///<summary>
	/// Label Share
	///<para>SObject Name: UserDefinedLabelShare</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfUserDefinedLabelShare : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "UserDefinedLabelShare"; }
		}
		...
		[Updateable(false), Createable(false)]
		public SfUserDefinedLabel Parent { get; set; }
