...
namespace NetCoreForce.Models
{
	...
	///<para>SObject Name: AuthorizationFormHistory</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfAuthorizationFormHistory : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "AuthorizationFormHistory"; }
		}

		///<summary>
		/// Authorization Form  History ID
		/// <para>Name: Id</para>
