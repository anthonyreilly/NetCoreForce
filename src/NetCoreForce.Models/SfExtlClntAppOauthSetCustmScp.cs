...
{
	///<summary>
	/// External Client App OAuth Settings Custom Scope
	///<para>SObject Name: ExtlClntAppOauthSetCustmScp</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppOauthSetCustmScp : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppOauthSetCustmScp"; }
		}

		///<summary>
		/// External Client App OAuth Settings Custom Scope ID
		/// <para>Name: Id</para>
