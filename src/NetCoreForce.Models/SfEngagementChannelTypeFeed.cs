...
{
	///<summary>
	/// Engagement Channel Type Feed
	///<para>SObject Name: EngagementChannelTypeFeed</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfEngagementChannelTypeFeed : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "EngagementChannelTypeFeed"; }
		}
