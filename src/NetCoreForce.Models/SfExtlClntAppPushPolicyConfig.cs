...
{
	///<summary>
	/// External Client Application Push Policy Config
	///<para>SObject Name: ExtlClntAppPushPolicyConfig</para>
	///<para>Custom Object: False</para>
	///</summary>
	public class SfExtlClntAppPushPolicyConfig : SObject
	{
		[JsonIgnore]
		public static string SObjectTypeName
		{
			get { return "ExtlClntAppPushPolicyConfig"; }
		}

		///<summary>
		/// External Client Application Push Policy Config ID
		/// <para>Name: Id</para>
		...
		///<summary>
		/// Is Full Content
		/// <para>Name: IsFullContent</para>
		/// <para>SF Type: boolean</para>
		/// <para>Nillable: False</para>
		///</summary>
		[JsonProperty(PropertyName = "isFullContent")]
		[Updateable(false), Createable(false)]
